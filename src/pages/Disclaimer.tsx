          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
            <div className="flex items-center gap-4 mb-10">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-2">Important information about using Property Launch Pad</p>
              </div>
            </div>
            ...
            <div className="space-y-8 text-gray-700 leading-7">
              ...
              <section>
                <h2 className="text-xl font-semibold text-gray-900 mb-4">Not Financial, Investment, Legal, or Tax Advice</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-semibold text-gray-900 mb-4">Estimates and Calculations</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-semibold text-gray-900 mb-4">Consult Qualified Professionals</h2>
                <p>
              ...
              <section>
                <h2 className="text-xl font-semibold text-gray-900 mb-4">No Liability</h2>
                <p>
              ...
              <section className="bg-amber-50 border border-amber-200 rounded-lg p-6 mt-10">
                <h2 className="text-xl font-semibold text-amber-900 mb-4">Important Reminder</h2>
              ...
              <section className="text-sm text-gray-500 mt-10 pt-6 border-t border-gray-200">
                <p>

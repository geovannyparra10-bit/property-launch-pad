  ...
  return (
    <div className="landing">
      <style>{`
        ...
        .landing-ctas { display: flex; gap: 14px; justify-content: center; flex-wrap: wrap; margin-bottom: 72px; }
        .cta-primary {
          display: inline-flex; align-items: center; gap: 8px; padding: 14px 32px;
          background: var(--accent, #6366f1); color: #fff; border-radius: 12px;
          font-size: 16px; font-weight: 700; text-decoration: none; transition: opacity 0.15s;
        }
        ...
        .cta-secondary {
          ...
          font-size: 16px; font-weight: 700; text-decoration: none; transition: border-color 0.15s;
        }
        .cta-secondary:hover { border-color: var(--border-hover, #3a4562); }
        .features { display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px; text-align: left; }
